...
filtSubclasses <- c("L2/3 IT")
filtCallawayProjection <- c("AL","PM")
filtCallawayType <- NULL #c("L23_AL","L23_PM")
filtCallawayMappedTType <- c("L2/3 IT VISp Adamts2","L2/3 IT VISp Agmat","L2/3 IT VISp Rrad")
layers <- "L23" # for filenames
onlyVISp <- TRUE
nGenes  <- 2000
...
curatedGenesFileName <-  "//allen/programs/celltypes/workgroups/rnaseqanalysis/agatab/exc_mouse_patchseq_R/data/L23_gene_list_for_integration.csv"
